...
namespace SpinAPI
{
	...
	bool StandardOutput::Validate(const std::map<std::string, RunSection::ActionScalar>& _scalars, const std::map<std::string, RunSection::ActionVector>& _vectors)
	{
		...
		if(str.compare("vector") == 0 || str.compare("vectorxyz") == 0 || str.compare("xyz") == 0 || str.compare("components") == 0) {this->type = StandardOutputType::VectorXYZ;}
		else if(str.compare("vectorangle") == 0 || str.compare("angle") == 0) {this->type = StandardOutputType::VectorAngle;}
		else if(str.compare("vectorlength") == 0 || str.compare("length") == 0) {this->type = StandardOutputType::VectorLength;}
		else if(str.compare("vectordot") == 0 || str.compare("dot") == 0 || str.compare("projection") == 0) {this->type = StandardOutputType::VectorDot;}
		else if(str.compare("scalar") == 0) {this->type = StandardOutputType::Scalar;}
		else
		{
