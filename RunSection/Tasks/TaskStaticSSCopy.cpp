...
namespace RunSection
{
	...
	// -----------------------------------------------------
	TaskStaticSSCopy::TaskStaticSSCopy(const MSDParser::ObjectParser &_parser, const RunSection &_runsection) : BasicTask(_parser, _runsection), reactionOperators(SpinAPI::ReactionOperatorType::Haberkorn),
																										productYieldsOnly(false)
	{
	}

	TaskStaticSSCopy::~TaskStaticSSCopy()
	{
	}
	// -----------------------------------------------------
	// TaskStaticSS protected methods
	// -----------------------------------------------------
	bool TaskStaticSSCopy::RunLocal()
	{
		this->Log() << "Running method StaticSS Copy." << std::endl;
	...
	void TaskStaticSSCopy::WriteHeader(std::ostream &_stream)
	{
		_stream << "Step ";
	...
	// Validation
	bool TaskStaticSSCopy::Validate()
	{
